    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br />
                Age: <input type="number" name="age" value={veggieData.age} onChange={(e) => setVeggieData({ ...veggieData, age: e.target.value })} />
                <br/>
                ...
                <br />
                Is Healthy: <input type="checkbox" name="isHealthy" value={veggieData.readyToEat}
